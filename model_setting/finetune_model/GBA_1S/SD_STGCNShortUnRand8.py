...
from main.main_arch.header import UniversalHeader, UniversalSTPHeader, Header, MLPHeader, STGCNHeader
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "SD_STGCNShortUnRand8"
...
CFG.MODEL.PARAM = {
    ...
    "predictor_args": {
        ...
        "Ks" : 2,
        "Kt" : 2,
        "blocks" : [[64], [64, 16, 64], [64, 16, 64], [128, 128], [CFG.DATASET_DESCRIBE.get("trg_len")]],
        "T" : CFG.DATASET_DESCRIBE.get("src_len"),
...
CFG.MODEL.PARAM["backbone_args"]["encoder_args"]["num_tokens"] =  CFG.DATASET_DESCRIBE.get("src_len") // BackBone.MODEL.PARAM["encoder_args"]["patch_length"]
...
CFG.MODEL.PARAM["predictor_args"]["num_tokens"] =  CFG.DATASET_DESCRIBE.get("src_len") // BackBone.MODEL.PARAM["encoder_args"]["patch_length"]
