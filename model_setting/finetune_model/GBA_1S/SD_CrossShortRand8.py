...
from main.main_arch.header import UniversalHeader, UniversalSTPHeader, Header, MLPHeader, STGCNHeader, CrossHeader
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "SD_CrossShortUnRand5"
...
CFG.MODEL.PARAM = {
    ...
    "predictor_args": {
        ...
        "data_dim": CFG.DATASET_DESCRIBE.get("num_nodes"),
        "in_len": CFG.DATASET_DESCRIBE.get("src_len"),
