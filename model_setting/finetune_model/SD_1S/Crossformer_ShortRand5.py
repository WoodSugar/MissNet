...
from main.main_arch.header import UniversalHeader, UniversalSTPHeader, Header, LRHeader, MLPHeader, STGCNHeader, CrossHeader
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "Crossformer_ShortRand5"
