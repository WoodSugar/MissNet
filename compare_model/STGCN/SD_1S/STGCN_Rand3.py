...
from compare_model.BTS_STGCN import STGCN_Seq2Seq

CFG = EasyDict()

# ================= general ================= #
CFG.DESCRIPTION = "STGCN on SD configuration"
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "STGCN_Rand3"
CFG.MODEL.ARCH = STGCN_Seq2Seq
...
CFG.MODEL.PARAM = {
    "Ks" : 2,
    "Kt" : 2,
    "blocks" : [[CFG.MODEL.INPUT_DIM], [64, 16, 64], [64, 16, 64], [128, 128], [CFG.DATASET_DESCRIBE.get("trg_len")]],
    ...
    "trg_len": CFG.DATASET_DESCRIBE.get("trg_len"),
    "num_tokens": None, 
    "patch_length": 1,

    "forecast_mask_args": {
        "rand_mask_ration": 0.3,
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    "result/compare_model/STGCN", CFG.DATASET_NAME,
