...
from compare_model.BTS_Crossformer import CrossformerSeq2Seq


CFG = EasyDict()

# ================= general ================= #
CFG.DESCRIPTION = "Crossformer on SD configuration"
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "Crossformer_Rand3"
CFG.MODEL.ARCH = CrossformerSeq2Seq
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    "result/compare_model/Crossformer", CFG.DATASET_NAME,
